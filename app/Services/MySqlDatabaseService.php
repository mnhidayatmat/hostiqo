...
class MySqlDatabaseService implements DatabaseServiceInterface
{
    ...
    public function canCreateDatabase(): array
    {
        try {
            ...
            $cacheKey = 'mysql_permissions_' . md5($currentUser);
    ...
    public function createDatabase(string $dbName, string $username, string $password, string $host = 'localhost'): void
    {
        try {
            ...
            throw new Exception("Failed to create MySQL database: " . $e->getMessage());
        }
    }
    ...
    public function changeUserPassword(string $username, string $newPassword, string $host = 'localhost'): void
    {
        try {
            ...
            throw new Exception("Failed to change MySQL password: " . $e->getMessage());
        }
    }
    ...
    public function deleteDatabase(string $dbName): void
    {
        try {
            ...
            throw new Exception("Failed to delete MySQL database: " . $e->getMessage());
        }
    }
    ...
    public function deleteUser(string $username, string $host = 'localhost'): void
    {
        try {
            ...
            throw new Exception("Failed to delete MySQL user: " . $e->getMessage());
        }
    }
